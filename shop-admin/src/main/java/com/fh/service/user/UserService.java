...
public interface UserService {
    ...
    ServerResponse registerUser(User user);

    void writeResource(Integer id, HttpServletRequest request);

    void refresh(HttpServletRequest request);

    ServerResponse forgetCode(String phone ,HttpServletRequest request);

    ServerResponse confirmPw(User user, String code, HttpServletRequest request);
}
